...
class CaptchaConfig(BaseModel):
    ...
    id: int = 1
    captcha_method: str = "browser"  # yescaptcha/capmonster/ezcaptcha/capsolver/browser/personal/remote_browser/extension
    ...
    personal_project_pool_size: int = 1  # 单个 Token 默认维护的项目池数量（仅影响项目轮换）
